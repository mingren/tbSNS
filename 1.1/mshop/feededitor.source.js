...
SNS("SNS.mshop.FeedEditor",function(){
    ...
    var topicList = '<div class="topiclist">'+
        ...
        '<ul>'+
        '<li><a href="#" class="topic">#wef#</a></li>'+
        '<li><a href="#" class="topic">#wef#</a></li>'+
        '<li><a href="#" class="topic">#wef#</a></li>'+
    ...
    var html= '<!--<div >你还可以输入<em class="num">140</em>个字</div>-->'+
        ...
        ' <div class="sns-nf"><div class="b"><textarea maxlength="140" name="content" class="f-area" >有啥想说的...</textarea></div></div>'+
        '<div class="act ">'+
    ...
    MicroBlog.prototype={
        ...
        addParam:function(name, value){
            ...
            if(!input){
                input = KISSY.DOM.create('<input type="hidden" class="addparam-'+name+'" name='+name+' value="'+value+'"/>');
                    ...
                    SNS.request(Helper.getApiURI("http://fx.{serverHost}/share/getElementByURL.htm"),{
                        ...
                        success:function(data){
                            if(data.status=="1"){
                                ...
                                submitType =2;
                                self._get("file-name","em").innerHTML = data.result.title;
