...
(function(win,K) {
    ...
    K.mix(SNS, {
        _init: function(o) {
            ...
            base = currentScript.src.replace(/^(.*)(sns)(.source)?\.js[^/]*/i, '$1');
                   ...
                   (function(n){
                       ...
                       self._load(n,{
                        ...
                        success:function(){
                             ...
                             var reqMod=Resource.get(n);
                            
                             if(reqMod.mixed)K.log("success "+n)
                             else K.log('miss '+n)
        ...
        nameToPath:function(name){
            ...
            if(h==0) {
              ...
              /*  if(name.indexOf("+") != -1)
                ...
                if(K.Config.debug)fmt=".source"+fmt;
